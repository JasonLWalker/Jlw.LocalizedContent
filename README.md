...
|[Microsoft.Extensions.Options](https://dot.net/)|8.0.2|[MIT](https://licenses.nuget.org/MIT)|Provides a strongly typed way of specifying and accessing settings using dependency injection.|
...
|[Microsoft.Extensions.FileProviders.Embedded](https://asp.net/)|6.0.35|[MIT](https://licenses.nuget.org/MIT)|File provider for files in embedded resources for Microsoft.Extensions.FileProviders.|
...
|[jquery](http://jquery.com/)|[3.6.0](https://github.com/jquery/jquery.git)|MIT|JavaScript library for DOM operations|
...
|[twitter-bootstrap](http://getbootstrap.com/)|[5.2.2](https://github.com/twbs/bootstrap)|MIT|The most popular front-end framework for developing responsive, mobile first projects on the web.|
